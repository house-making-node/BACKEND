...
import { addSubscriptionInfo, addSharedLetter, lettersPreview, getLetterById, submitOpinion, addLetterToScrap, deleteLetterFromScrap } from "../controllers/share_letters.controller.js";
...
sharelettersRouter.put('/subscribe',asyncHandler(addSubscriptionInfo)); // 공유레터 구독정보 저장하기
...
sharelettersRouter.delete('/scrapX',asyncHandler(deleteLetterFromScrap)); // 특정 공유레터 스크랩에서 제외하기